...
def test_pickup_delivery():
    ...
    delivery = delivery_service.create_delivery("100","Pickup","Dropoff")
    delivery_service.assign_driver(delivery.id, "driver-1")
    updated = delivery_service.pickup_delivery(delivery.id, "driver-1")
...
def test_start_transit():
    ...
    delivery = delivery_service.create_delivery("100","Pickup","Dropoff")
    delivery_service.assign_driver(delivery.id, "driver-1")
    delivery_service.pickup_delivery(delivery.id, "driver-1")
    updated = delivery_service.start_transit(delivery.id, "driver-1")
...
def test_complete_delivery():
    ...
    delivery_service.assign_driver(delivery.id, "driver-1")
    delivery_service.pickup_delivery(delivery.id, "driver-1")
    delivery_service.start_transit(delivery.id, "driver-1")
    updated = delivery_service.complete_delivery(delivery.id, "driver-1")
...
def test_cancel_completed_delivery():
    ...
    delivery_service.pickup_delivery(delivery.id, "driver-1")
    delivery_service.start_transit(delivery.id, "driver-1")
    delivery_service.complete_delivery(delivery.id, "driver-1")
    with pytest.raises(ValueError):
        delivery_service.cancel_delivery(delivery.id)
